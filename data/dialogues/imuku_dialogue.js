export const imukuDialogue = [
  {
    ...
    options: [
      ...
      { label: 'What are yellow tiles?', goto: 3 },
      { label: 'What are red triangles?', goto: 4 },
  ...
  {
    text: 'Yellow tiles are chests. Open them to find items, though some may be locked.',
    options: [{ label: 'I\'ll remember.', goto: null }]
  },
  {
