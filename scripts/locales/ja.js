export default {
  ...
  'frederica.dialogue.trade_offer.text': '防御ポーションを三つ？どうしても必要なんだ。',
  'frederica.dialogue.trade_offer.0': 'はい、どうぞ。',
  'frederica.dialogue.trade_offer.1': 'また今度。',
  'frederica.dialogue.trade_denied.text': 'もし防御ポーションを三つ持ってきたら…良い物をやろう。',
